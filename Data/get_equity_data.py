...
for ticker in sp100_tickers:
    ...
    data.columns = [f"{ticker}_{c}" for c in data.columns]
    sp100_data[ticker] = data



# df = pd.DataFrame({k : v for k, v in sp100_data.items()}, index = sp100_data['AAPL'].index)    

# df.to_csv("SP100_Close_2012_2022.csv")
sp100_data['AAPL'].to_csv("AAPL_FULL_2012_2022.csv")
